...
const qunitRecommended = require("eslint-plugin-qunit/configs/recommended");
...
module.exports = [
  ...
  qunitRecommended,
  {
    ...
    plugins: {
      ember: require("eslint-plugin-ember"),
      ...
      qunit: require("eslint-plugin-qunit"),
      "eslint-discourse": require("./eslint-discourse/index.cjs"),
    },
    rules: {
      ...
      "eslint-discourse/i18n-import": "error",
    },
  },
  {
    files: ["**/*.gjs", "**/*.gts"],
